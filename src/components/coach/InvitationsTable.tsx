      ...
      <div className="flex items-baseline justify-between mb-5">
        <div>
          ...
          <p className="text-gray-400 font-light mt-1.5">
            invite your client to click invite button. and share link to their
            emails.
          </p>
        </div>
                ...
                clients.map((client: Client) => (
                  ...
                  >
                    ...
                    <td className="text-center">
                      {client.invite_sent === true ? (
                        <button
                          className="text-blue-400 text-[12px] px-2 py-1 bg-blue-500/10 border border-blue-500/30 rounded"
