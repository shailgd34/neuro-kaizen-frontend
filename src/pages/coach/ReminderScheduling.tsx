...
import { getReminderSchedule, updateReminderSchedule, type ReminderSchedule } from "../../api/adminApi";
...
export default function ReminderScheduling() {
   ...
   const [schedule, setSchedule] = useState<ReminderSchedule>({
      weekly: { day: 'Monday', time: '09:00', enabled: true },
      followUp: { enabled: true }
   });

   const { data, isLoading } = useQuery({
      queryKey: ["reminder-schedule"],
      queryFn: getReminderSchedule,
   });
   ...
   const mutation = useMutation({
      ...
      onSuccess: () => {
         ...
         console.log("Submitted Payload:", schedule);
      },
      onError: () => {
      ...
      <div className="pb-20 animate-in fade-in duration-700">
         <main className="container mx-auto px-6 lg:px-12 py-10 max-w-5xl">
            ...
            <div className="flex flex-col gap-4 mb-8">
               <h1 className="text-3xl font-black text-white tracking-tight">Weekly Reminder Scheduling</h1>
            ...
            <div className="bg-[#0B0F1A] border border-secondary/20 rounded-2xl p-5 mb-8 flex gap-4">
               ...
               <div className="space-y-1">
                  ...
                  <p className="text-[10px] text-gray-500 leading-relaxed font-medium">Each client receives one weekly reminder and one follow-up reminder if the weekly entry remains incomplete after 48 hours.</p>
               </div>
            </div>
            ...
            <div className="space-y-8">
               ...
               <Card className="p-8 bg-[#0B0F1A]/40 border-white/5 backdrop-blur-xl">
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="relative group">
                           <select
                              ...
                              onChange={(e) => setSchedule(prev => ({ ...prev, weekly: { ...prev.weekly, day: e.target.value } }))}
                     ...
                     <div className="space-y-3">
                        ...
                        <div className="relative group">
                           <input
                              ...
                              onChange={(e) => setSchedule(prev => ({ ...prev, weekly: { ...prev.weekly, time: e.target.value } }))}
                  ...
                  <div className="flex items-center justify-between p-6 bg-white/[0.02] border border-white/5 rounded-2xl">
                     ...
                     <label className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" className="sr-only peer" checked={schedule.weekly.enabled} onChange={() => setSchedule(prev => ({ ...prev, weekly: { ...prev.weekly, enabled: !prev.weekly.enabled } }))} />
               ...
               <Card className="p-8 bg-[#0B0F1A]/40 border-white/5 backdrop-blur-xl">
                  <div className="mb-8">
                     <h4 className="text-lg font-black text-white mb-1">48-Hour Follow-Up Reminder</h4>
                     <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest">Send a follow-up email 48 hours after the weekly reminder if the submission remains incomplete.</p>
                  </div>

                  <div className="flex items-center justify-between p-6 bg-white/[0.02] border border-white/5 rounded-2xl mb-8">
                     <div className="space-y-1">
                        <p className="text-sm font-bold text-white">Enable Follow-Up Reminder</p>
                        <p className="text-[10px] font-medium text-gray-500">Send reminder 48 hours after primary if incomplete</p>
                     </div>
                     <label className="relative inline-flex items-center cursor-pointer">
                        <input type="checkbox" className="sr-only peer" checked={schedule.followUp.enabled} onChange={() => setSchedule(prev => ({ ...prev, followUp: { enabled: !prev.followUp.enabled } }))} />
                        <div className="w-12 h-6 bg-white/10 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[4px] after:start-[4px] after:bg-gray-400 after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-emerald-500 peer-checked:after:bg-white"></div>
                     </label>
                  </div>
                  ...
                  <div className="bg-white/[0.01] border border-white/5 rounded-xl p-4 flex gap-3">
                     ...
                     <p className="text-[9px] font-medium text-gray-600 italic">Sent automatically if weekly submission is incomplete 48 hours after primary reminder. Follow-up reminders are triggered only when submission status remains pending.</p>
                  </div>
               </Card>
